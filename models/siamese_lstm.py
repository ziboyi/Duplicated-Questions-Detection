...
class SiameseLSTM(object):
    ...
    Uses an embedding layer, followed by a LSTM, MLP and softmax layer.
    """
    def __init__(
    ...
    #   create_tower(embedded_x1,      sequence_length, embedding_size, filter_sizes, num_filters, self.input_x1_length, "0", False)
